...
namespace GameProject
{
    ...
    class NumberBoard
    {
        ...
        {   
            ...
            tileSideLength = (sideLength - (4 * BORDER_SIZE)) / NUM_COLUMNS;
            ...
            for (int i = 0; i < NUM_ROWS; i++)
            {
                ...
                {
                    counter++;
                    tiles[i, j] = new NumberTile(contentManager, CalculateTileCenter(i, j), tileSideLength,counter , correctNumber, soundBank);
                }
            }
        ...
        public bool Update(GameTime gameTime, MouseState mouse)
        {
            ...
            for (int i = 0; i < NUM_COLUMNS; i++)
            {
                ...
                {
                    isCorrectNumber = tiles[i, j].Update(gameTime, mouse);
        ...
        private void LoadContent(ContentManager contentManager)
        {
            ...
            drawRectangle = new Rectangle(0, 0, boardTexture.Width, boardTexture.Height);
